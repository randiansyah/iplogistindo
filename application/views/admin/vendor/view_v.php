...
<section class="content">
  <div class="box box-default color-palette-box">
    ...
    <h3 class="box-title"><i class="fa fa-search"></i>&nbsp;&nbsp;Data Karyawan</h3>
    </div>
      ...
      <div class="row">
        <div class="col-md-4">
          ...
          <div class="form-group">
            ...
            <select class="form-control filter-column fkdprop" id="KDCBG" name="KDCBG" readonly>
            <option value="" selected>Semua Cabang</option>
               <?php foreach($cabang as $data) { ?>
            <option value="<?php echo $data->KDCBG ?>" <?php if($KDCBG==$data->KDCBG) { echo "selected"; } ?>>
      <?php echo $data->KDCBG; ?>
            </option>
            <?php } ?>
            </select> 
           ...
           <div class="form-group">
            ...
            <input class="form-control" id="KDPGW" name="KDPGW" value="<?php echo $KDPGW;?>" autocomplete="off" readonly>
          </div>  
           <div class="form-group">
            <label for="">Nama</label>
            <input class="form-control" value="<?php echo $nama;?>" id="nama" name="nama" autocomplete="off"  readonly>
          </div>   
           <div class="form-group">
            <label for="">Nickname</label>
            <input class="form-control" id="nickname" value="<?php echo $nickname;?>"   name="nickname"readonly>
          </div>  
           <div class="form-group">
          ...
          <div class="input-group date">
                  ...
                  <input type="text" class="form-control pull-right datepicker" id="mulai_bekerja" name="mulai_bekerja" value="<?php echo $mulai_bekerja;?>"  readonly>
                </div>
          </div>   
              <div class="form-group">
            <label for="">Alamat sesuai KTP</label>
 <textarea cols="4" rows="5" value="<?php echo $alamat;?>"   class="form-control" id="alamat" name="alamat" readonly><?php echo $alamat;?></textarea>
                    
          </div> 
           <div class="form-group">
            <label for="">Alamat sekarang</label>
        <textarea cols="4" rows="4" value="<?php echo $alamat_saat_ini; ?>" class="form-control" id="alamat_saat_ini" name="alamat_saat_ini" readonly><?php echo $alamat_saat_ini;?></textarea>            
          </div>
     <div class="form-group">
            <label for="">No KTP</label>
            <input class="form-control" id="KTP" name="KTP" value="<?php echo $KTP; ?>" autocomplete="off" readonly>
          </div>
      ...
      <div class="form-group">
            ...
            <input class="form-control" id="tempat_lahir" name="tempat_lahir" value="<?php echo $tempat_lahir; ?>" autocomplete="off" readonly>
          </div>
           <div class="form-group">
            <label for="">Tanggal Lahir</label>
            <input class="form-control datepicker" id="tgl_lahir" name="tgl_lahir" value="<?php echo $tgl_lahir; ?>" autocomplete="off" readonly>
          </div>
            <div class="form-group">
            <label for="">Agama</label>

             <select name="agama" class="form-control" id="agama" disabled="true">
...
<option value="Katholik" <?php if('Katholik'==$agama) { echo "selected"; } ?>>Katholik</option>
          ...
          <div class="form-group">
           ...
           <select name="jenis_kelamin" class="form-control" id="jenis_kelamin" disabled="true">
...
<option value="Perempuan" <?php if('Perempuan'==$jenis_kelamin) { echo "selected"; } ?>>Perempuan</option>                        
 ...
 <div class="form-group">
            ...
            <input class="form-control" value="<?php echo $no_hp;?>" id="no_hp" name="no_hp" autocomplete="off" readonly>
          </div>
                <div class="form-group">
            <label for="">Golongan Darah</label>
           <select name="golongan_darah" class="form-control" id="golongan_darah" disabled="true">
                  <option>Pilih salah satu</option> 
...
<option value="O" <?php if('O'==$golongan_darah) { echo "selected"; } ?>>O</option>
            ...
            <div class="form-group">
            <label for="">SIM</label>
           <select name="sim" class="form-control" id="sim" disabled="true">
                  <option>Pilih salah satu</option>
           ...
           <select name="status_pernikahan" class="form-control" id="status_pernikahan" disabled="true">
                  <option>Pilih salah satu</option>
...
<option value="DD"  <?php if('DD'==$status_pernikahan) { echo "selected"; } ?>>[DD] Duda</option>                
          ...
          <div class="form-group">
           ...
           <select name="pendidikan_terakhir" class="form-control" id="pendidikan_terakhir" disabled="true">
                  <option>Pilih salah satu</option>
...
<option value="S3" <?php if('S3'==$pendidikan_terakhir) { echo "selected"; } ?>>[S3] Strata 3</option>                     
          ...
          <input class="form-control" value="<?php echo $instansi_pendidikan; ?>" id="instansi_pendidikan" name="instansi_pendidikan" autocomplete="off" readonly>
          </div>
          </div>
          <div class="col-md-4">
          ...
          <select name="staff_level" class="form-control" id="staff_level" disabled="true">
                  <option>Pilih salah satu</option>
...
<option value="TRAINEE" <?php if('TRAINEE'==$staff_level) { echo "selected"; } ?>>[TRAINEE] Trainee</option>                       
          ...
          <select name="divisi" class="form-control" id="divisi" disabled="true">
                  <option value="" selected="">Pilih salah satu</option>              
 <option value="ALL" <?php if('ALL'==$staff_level) { echo "selected"; } ?>>[ALL] Kantor</option>
 <option value="AUD" <?php if('AUD'==$staff_level) { echo "selected"; } ?>>[AUD] Audit</option>
 <option value="BDV" <?php if('BDV'==$staff_level) { echo "selected"; } ?>>[BDV] Bussiness Development</option>
 <option value="BOA" <?php if('BOA'==$staff_level) { echo "selected"; } ?>>[BOA] Board Of Adviser</option>
 <option value="BOD" <?php if('BOD'==$staff_level) { echo "selected"; } ?>>[BOD] Board Of Director</option>
 <option value="FIN" <?php if('FIN'==$staff_level) { echo "selected"; } ?>>[FIN] Finance</option>     
 <option value="GAF" <?php if('GAF'==$staff_level) { echo "selected"; } ?>>[GAF] GA</option>
 <option value="HRD" <?php if('HRD'==$staff_level) { echo "selected"; } ?>>[HRD] HRD</option>
<option value="ITE" <?php if('ITE'==$staff_level) { echo "selected"; } ?>>[ITE] IT</option>
<option value="HRD" <?php if('HRD'==$staff_level) { echo "selected"; } ?>>[HRD] HRD</option>
<option value="LOG" <?php if('LOG'==$staff_level) { echo "selected"; } ?>>[LOG] Logistik</option>
<option value="MKT" <?php if('MKT'==$staff_level) { echo "selected"; } ?>>[MKT] Marketing</option>
<option value="OPM" <?php if('OPM'==$staff_level) { echo "selected"; } ?>>[OPM] Operational Manager</option>
<option value="PRJ" <?php if('PRJ'==$staff_level) { echo "selected"; } ?>>[PRJ] Project</option>
<option value="PRO" <?php if('PRO'==$staff_level) { echo "selected"; } ?>>[PRO] Produksi</option>
<option value="PUR" <?php if('PUR'==$staff_level) { echo "selected"; } ?>>[PUR] Purchasing</option>
<option value="REC" <?php if('REC'==$staff_level) { echo "selected"; } ?>>[REC] Receiving</option>
<option value="SLS" <?php if('SLS'==$staff_level) { echo "selected"; } ?>>[SLS] Sales</option>
<option value="SPV" <?php if('SPV'==$staff_level) { echo "selected"; } ?>>[SPV] Sales</option>
<option value="TRO" <?php if('TRO'==$staff_level) { echo "selected"; } ?>>[TRO] raining Officer</option>
</select>
          </div>
          <div class="form-group">
           <label for="">Status KaryawanKaryawan</label>
          <select name="status_karyawan" class="form-control" id="status_karyawan" disabled="true">
                  <option>Pilih salah satu</option> 
...
<option value="Tetap" <?php if('Tetap'==$status_karyawan) { echo "selected"; } ?>>Tetap</option>
            ...
            <img class="img-responsive" src="<?php echo base_url('assets/upload/').$photo; ?>" alt="Photo">
          </div>
           <div class="form-group">
            <label for="">Status</label>
          <div class="radio" id="status" name="status" disabled="true">
 ...
 <label><input type="radio" name="status" value="0"  <?php if('0'==$status) { echo "checked='checked'"; } ?>>Tidak Aktif</label>
      ...
      <input class="form-control" type="hidden" value="<?php echo $this->data['users']->id;?>" id="user_input" name="user_input" readonly>
