...
<div class="form-group"><div class="col-md-12"><label>Werehouse</label></div></div><br>
 <div class="col-lg-3 col-xs-6">
  <div class="small-box bg-aqua">
        <div class="inner">
       <h3>  <?php print_r($werehouse);?></h3>

          <p>SPB Barang Masuk [Belum Di Proses]</p>
        </div>
        <div class="icon">
          <i class="fa fa-home"></i>
        </div>
        <a href="<?php echo base_url('/Werehouse')?>" class="small-box-footer">Jumlah SPB Dari Pickadel</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
       ...
       <h3>  <?php print_r($selesai_pickup);?></h3>
        ...
        <a href="<?php echo base_url('/Werehouse')?>" class="small-box-footer">selesai di Konfirmasi</a>
      </div>
    </div>