 ...
 <div class="col-lg-3 col-xs-6">
  <div class="small-box bg-aqua">
       ...
       <h3>  <?php print_r($belum_dipickup);?></h3>
          ...
          <p>Pickup [Belum Di Proses]</p>
        </div>
        <div class="icon">
          <i class="fa fa-home"></i>
        </div>
        <a href="<?php echo base_url('/Pickup')?>" class="small-box-footer">Jumlah Permintaan Pickup</a>
      </div>
    </div>
      ...
      <div class="small-box bg-green">
       ...
       <h3>  <?php print_r($sedang_pickup);?></h3>
        ...
        <a href="<?php echo base_url('/pickup')?>" class="small-box-footer">Jumlah Yang Sedang di Pickup</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
       ...
       <h3>  <?php print_r($selesai_pickup);?></h3>
        ...
        <a href="<?php echo base_url('/Pickup')?>" class="small-box-footer">Jumlah Yang selesai di pickup</a>
      </div>
    </div>
    <div class="form-group"><div class="col-md-12"><label>Delivery</label></div></div><br>
      ...
      <div class="small-box bg-red">
        <div class="inner">
          ...
          <p>delivery [Belum Di Proses]</p>
        </div>
        <div class="icon">
          <i class="fa fa-cubes"></i>
        </div>
        <a href="<?php echo base_url('/list_delivery')?>" class="small-box-footer">Jumlah Yang Belum Di Delivery</a>
      </div>
    </div>
      ...
      <div class="small-box bg-green">
       ...
       <h3>  <?php print_r($sedang_delivery);?></h3>
        ...
        <a href="<?php echo base_url('/list_delivery')?>" class="small-box-footer">Jumlah Yang Sedang di delivery</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
       ...
       <h3>  <?php print_r($selesai_delivery);?></h3>
        ...
        <a href="<?php echo base_url('/list_delivery')?>" class="small-box-footer">Jumlah Yang sudah selesai di terima</a>
      </div>
    </div> 