...
<div class="form-group"><div class="col-md-12"><label>Pickup</label></div></div><br>
    <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-aqua">
        <div class="inner">
       <h3>  <?php print_r($permintaan_pesanan);?></h3>
        ...
        <a href="<?php echo base_url('/Permintaan_pesanan')?>" class="small-box-footer">Jumlah Permintaan Pesanan</a>
      </div>
    </div>
      ...
      <div class="small-box bg-red">
        <div class="inner">
          <h3> <?php print_r($belum_dipickup);?></h3>
        ...
        <a href="<?php echo base_url('/jadwal_pickup')?>" class="small-box-footer">Jumlah Yang Belum Di Pickup</a>
      </div>
    </div>
      ...
      <div class="small-box bg-green">
        <div class="inner">
       <h3>  <?php print_r($sedang_pickup);?></h3>

          <p>Sedang Di Pickup</p>
        </div>
        <div class="icon">
          <i class="fa fa-truck"></i>
        </div>
        <a href="<?php echo base_url('/Permintaan_pesanan')?>" class="small-box-footer">Jumlah Yang Sedang di Pickup</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
        <div class="inner">
       <h3>  <?php print_r($selesai_pickup);?></h3>

          <p>Selesai Di Pickup</p>
        </div>
        <div class="icon">
          <i class="fa fa-truck"></i>
        </div>
        <a href="<?php echo base_url('/Permintaan_pesanan')?>" class="small-box-footer">Jumlah Yang selesai di pickup</a>
      </div>
    </div><br>
<div class="form-group"><div class="col-md-12"><label>Delivery</label></div></div><br>
 <div class="col-lg-3 col-xs-6">
  <div class="small-box bg-aqua">
        <div class="inner">
       <h3>  <?php print_r($barang_masuk);?></h3>

          <p>SPB Barang Masuk</p>
        </div>
        <div class="icon">
          <i class="fa fa-home"></i>
        </div>
        <a href="<?php echo base_url('/SPB_barang_masuk')?>" class="small-box-footer">Jumlah SPB Dari Werehouse</a>
      </div>
    </div>
   <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-red">
        <div class="inner">
          <h3> <?php print_r($belum_delivery);?></h3>

          <p>Belum Di delivery</p>
        </div>
        <div class="icon">
          <i class="fa fa-cubes"></i>
        </div>
        <a href="<?php echo base_url('/SPB_barang_masuk')?>" class="small-box-footer">Jumlah Yang Belum Di Delivery</a>
      </div>
    </div>
      ...
      <div class="small-box bg-green">
        <div class="inner">
       <h3>  <?php print_r($sedang_delivery);?></h3>

          <p>Sedang Di delivery</p>
        </div>
        <div class="icon">
          <i class="fa fa-truck"></i>
        </div>
        <a href="<?php echo base_url('/SPB_barang_masuk')?>" class="small-box-footer">Jumlah Yang Sedang di delivery</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
        <div class="inner">
       <h3>  <?php print_r($selesai_delivery);?></h3>
        ...
        <a href="<?php echo base_url('/SPB_barang_masuk')?>" class="small-box-footer">Jumlah Yang sudah selesai di terima</a>
      </div>
    </div>
...
<div class="small-box bg-red">
        <div class="inner">
         ...
         <h3>
                ...
                <input type="text" id="inv" class="form-control">
                    <span class="input-group-btn">
                      <button type="button" id="search" class="btn btn-info btn-flat">Cari</button>
                    </span>
              </div>
