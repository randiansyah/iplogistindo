    ...
    <div class="col-lg-3 col-xs-6">
      ...
      <div class="small-box bg-aqua">
       ...
       <h3>  <?php print_r($permintaan_pesanan);?></h3>
        ...
        <a href="#" class="small-box-footer">Jumlah Permintaan Pesanan</a>
      </div>
    </div>
      ...
      <div class="small-box bg-red">
        ...
        <a href="#" class="small-box-footer">Jumlah Yang Belum Di Pickup</a>
      </div>
    </div>
      ...
      <div class="small-box bg-green">
       ...
       <h3>  <?php print_r($sedang_pickup);?></h3>
        ...
        <a href="#" class="small-box-footer">Jumlah Yang Sedang di Pickup</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
       ...
       <h3>  <?php print_r($selesai_pickup);?></h3>
        ...
        <a href="#" class="small-box-footer">Jumlah Yang selesai di pickup</a>
      </div>
    </div><br>
 ...
 <div class="col-lg-3 col-xs-6">
  <div class="small-box bg-aqua">
       ...
       <h3>  <?php print_r($barang_masuk);?></h3>
        ...
        <a href="#" class="small-box-footer">Jumlah SPB Dari Werehouse</a>
      </div>
    </div>
   <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-red">
        ...
        <a href="#" class="small-box-footer">Jumlah Yang Belum Di Delivery</a>
      </div>
    </div>
      ...
      <div class="small-box bg-green">
       ...
       <h3>  <?php print_r($sedang_delivery);?></h3>
        ...
        <a href="#" class="small-box-footer">Jumlah Yang Sedang di delivery</a>
      </div>
    </div>
 <div class="col-lg-3 col-xs-6">
      <!-- small box -->
      <div class="small-box bg-yellow">
       ...
       <h3>  <?php print_r($selesai_delivery);?></h3>
        ...
        <a href="#" class="small-box-footer">Jumlah Yang sudah selesai di terima</a>
      </div>
    </div>
