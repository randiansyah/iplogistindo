...
<section class="content">
  <div class="box box-default color-palette-box">
    ...
    <h3 class="box-title"><i class="fa fa-tag"></i>Invoice Details</h3>
        <div class="datatableButton pull-right">
   <a href="<?php echo base_url('Transaksi_cs/pdf/'.$id_transaksi)?>" target="blank" id="pdf" class="btn btn-sm btn-success"><i class="fa fa-download"></i>&nbsp;Cetak Invoice</a>      
   </div> 
    ...
    <div class="box-body">
      ...
      <option value="<?php echo $val->id;?>"  <?php echo $val->id == $vendorData ? 'selected' : '' ?>><?php echo $val->nama ?></option>
        ...
        <textarea cols="3" rows="3" value="" class="form-control" id="catatan" name="catatan" style="text-align: left;">
      ...
      <input class="form-control datetime" value="<?php echo $tgl_pengajuan ?>"  type="text" id="tgl_rilis" name="tgl_rilis">
    
          </div>
            <div class="col-md-6">
           <label for="">Tgl Jatuh Tempo</label>
      <input class="form-control datetime" value="<?php echo $tgl_jatuh_tempo ?>" type="text" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo">
...
<td><input type="text" class="harga_satuan form-control harga" id-tr="<?php echo $i-1; ?>" name="harga_satuan[]"  value="<?php echo "Rp.".number_format($val->harga_satuan, 0, ".", ".") ?>">

</td>

  
  <td><input type="text" id-tr="<?php echo $i-1; ?>"  class="total_harga form-control harga" id="total_harga" name="total_harga[]"  value="<?php echo "Rp.".number_format($val->total_harga_satuan, 0, ".", ".") ?>">
 ...
 <div class="col-md-12">
      ...
      <div class="col-md-3">
         <label for="" >Sub Total Harga</label>
          <input class="form-control harga" value="<?php echo "Rp.".number_format($total_harga, 0, ".", ".") ?>" id="sub_total" name="sub_total" autocomplete="off">
           </div>
     ...
     <input class="form-control harga packing" value="<?php echo "Rp.".number_format($harga_packing, 0, ".", ".") ?>" id="harga_packing" name="harga_packing" autocomplete="off">
        <input  type="hidden" value="" id="harga_packing_convert" name="harga_packing_convert" autocomplete="off">
         ...
         <label for="" >Harga Asuransi</label>
          <input class="form-control harga asuransi" value="<?php echo "Rp.".number_format($harga_asuransi, 0, ".", ".") ?>" id="harga_asuransi" name="harga_asuransi" autocomplete="off">
            <input  type="hidden" value="" id="harga_asuransi_convert" name="harga_asuransi_convert" autocomplete="off">
           </div>
       <div class="col-md-3">
          
         <label for="">Total Tagihan</label>
          <input class="form-control harga"   value="<?php echo "Rp.".number_format($grand_total, 0, ".", ".") ?>" id="grand_total" name="grand_total" autocomplete="off">
           </div>
