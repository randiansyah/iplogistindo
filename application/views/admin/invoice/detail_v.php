...
<section class="content">
  <div class="box box-default color-palette-box">
    ...
    <h3 class="box-title"><i class="fa fa-tag"></i> RINCIAN INVOICE</h3>
         <div class="datatableButton pull-right">
      <a href="<?php echo base_url('Transaksi/pdf/'.$id_transaksi)?>" target="blank" id="pdf" class="btn btn-sm btn-success"><i class="fa fa-download"></i>&nbsp;Cetak Invoice</a> 
    </div>
         ...
         <div class="form-group">
          ...
          <div class="form-group">
            <label for="">Catatan Tambahan</label>
             <textarea class="form-control" value="<?php echo $catatan ?>" id="catatan" name="catatan" autocomplete="off"><?php echo $catatan ?></textarea> 
          </div>
   ...
   <div class="form-group row">
      ...
      <input class="form-control"  type="text" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo" value="<?php echo $tgl_jatuh_tempo ?>">
