...
<section class="content">
  <div class="box box-default color-palette-box">
   ...
   <a href="<?php echo base_url('Transaksi/pdf/').$id_transaksi?>" class="btn btn-sm btn-success" target="blank" ><i class="fa fa-download"></i>&nbsp;Cetak Invoice</a>      
   </div>
    ...
    <div class="box-body">
      ...
      <input class="form-control " value="<?php echo $tgl_jatuh_tempo; ?>"  type="text" id="tgl_jatuh_tempo" name="tgl_jatuh_tempo">
          </div>
...
<td>
   <select class="form-control select2" id="opsi_satuan" name="opsi_satuan[]">
                  ...
                  <option value="cu">Coli & Unit</option> 
                  <option value="ku">KG & Unit</option>   
                  <option value="kc">KG & Coli</option>  
                </select>
    ...
    <div class="col-md-6">
      ...
      <div class="col-md-3">
         ...
         <label for="">Sub Total Harga Global</label>
          <input class="form-control harga" value="<?php echo "Rp.".number_format($total_harga_packing, 0, ".", ".") ?>" id="total_harga_global" name="total_harga_global" autocomplete="off">
