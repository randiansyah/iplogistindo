...
<section class="content">
  <div class="box box-default color-palette-box">
    ...
    <h3 class="box-title"><i class="fa fa-tag"></i> Konfirmasi Delivery</h3>
   ...
   <div class="form-group row">
        ...
        <textarea cols="4" rows="5" vlaue="<?php echo $alamat ?>" class="form-control" id="alamat" name="alamat"><?php echo $alamat ?></textarea>            
         ...
         <label for=""> Jadwal Delivery</label>
         <input type="text" class="form-control" value="<?php echo $jadwal_delivery?>">
            </div>
