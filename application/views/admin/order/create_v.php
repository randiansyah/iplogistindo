  ...
  <div class="box box-default color-palette-box">
    ...
    <div class="box-body">
      ...
      <option value="<?php echo $val->id;?>"><?php echo $val->nama ?></option>
        ...
        <textarea cols="4" rows="5" class="form-control" id="catatan" name="catatan"></textarea>            
          </div>
   ...
   <div class="form-group row">
        ...
        <textarea cols="4" rows="5" class="form-control" id="alamat_tujuan" name="alamat_tujuan"></textarea>            
          </div>
