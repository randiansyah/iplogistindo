      ...
      <div class="row">
        <?php 
             if($this->data['is_can_create']){
              ?>
             <a href="<?php echo base_url().$this->uri->segment(1)?>/create" class="btn btn-sm btn-primary"><i class='fa fa-plus'></i> <?php echo ucwords(str_replace("_"," ",$this->uri->segment(1)))?></a>
               <?php
               }else{
