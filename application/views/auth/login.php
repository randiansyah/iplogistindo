...
<head>
  ...
  <title>iP Logistindo | Log in</title>
...
<div class="login-box">
  <div class="login-logo">
    <img src="<?php echo base_url()?>assets/images/logo.png" width="150"><br>
    <a href="<?php echo base_url()?>"><b>iP</b> LOGISTINDO</a>
  </div>
  <!-- /.login-logo -->
...
<!-- /.login-box -->
<center>
<p style="color:white">&copy; Copyright <?php echo date('Y');?> <b>iP Logistindo</b> - Powered By <a href="https://manggadingin.com" target="_blank" style="color: white">Mangga Dingin</a> <br> Beta Version</p>
</center>
